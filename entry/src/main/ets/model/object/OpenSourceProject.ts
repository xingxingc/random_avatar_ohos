...
export const kOpenSourceProjectList = [
	// new OpenSourceProject("gopherize.me", "matryer", "“Gopher”效仿于该项目", "https://github.com/matryer/gopherize.me"),
...
export const kMyOpenSources = [
	new MyOpenSource('github: stray_avatar', 'https://github.com/xingxingc/stray_avatar'),
	new MyOpenSource('gitee: stray_avatar', 'https://gitee.com/lucifer_c/stray_avatar')
]